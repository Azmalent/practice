...
void ModelImporter::getBufferData(QVector<float>** vertices, QVector<float>** normals, QVector<uint>** indices)
{
...
QSharedPointer<Node> ModelImporter::getRoot()
{
